...
const CarText = () => {
  return (
    <section className='relative py-12 md:py-40 md:w-11/12 md:my-12 mx-auto flex justify-center items-center bg-bottom bg-no-repeat' style={{backgroundImage:"url('/quiz-bg.png')"}}>
