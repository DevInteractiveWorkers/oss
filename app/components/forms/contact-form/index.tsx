...
const ContactFormComponent = () => {
  ...
  return (
    <form className='py-32 w-5/6 mx-auto flex flex-col items-center' onSubmit={onSubmit}>
      <h2 className='text-center text-[#4F4E4F] text-8xl font-bebas'>EMPLOYMENT APPLICATION FORM</h2>
      ...
      <button className='py-2 px-8 rounded-xl text-5xl font-bebas bg-[#F0B631]'> SEND </button>
    </form>
  )
}
